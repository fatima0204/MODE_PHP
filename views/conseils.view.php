...
<table id="tablelis" class="table text-center">
    ...
    <tr>
        ...
        <td class="align-middle">
            <form method="POST" action="index.php?page=conseils/s/<?= $conseils[$i]->getId();?>" onSubmit="return confirm('Voulez-vous vraiment supprimer l'article ?');">
